...
.. code-block:: bash
   ...
   root@j7-evm:/opt/edge_ai_apps# ./download_models.sh --help
...
The Processor SDK Linux for Edge AI also supports importing pre-trained custom
...
.. _pub_edgeai_compile_artifacts:

DNN compilation for SDK – Basic Instructions
--------------------------------------------

The Processor SDK Linux for Edge AI supports three different runtimes to infer
